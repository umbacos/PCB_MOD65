/* Copyright 2025 umbacos <https://github.com/umbacos>
 *
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC] = LAYOUT_65_ansi(
      ...
      KC_LCTL, KC_LALT, KC_LCMD,                            KC_SPC, KC_RALT,                    MO_FN2,  MO_FN1,  KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [FN1] = LAYOUT_65_ansi(
      ...
      _______, _______, _______,                            C_PLYP,  _______,                   _______, _______, KC_MPRV, KC_VOLD, KC_MNXT
    ),
